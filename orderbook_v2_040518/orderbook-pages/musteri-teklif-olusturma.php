...
<body>
	...
	<section class="section">
		...
		<div class="orta2a">
			<h1>Dear <?php echo $usersname; ?> </h1>
			<h2>Welcome to quotation page </h2>
			<p>Please fill in quotes and click on <b>"Send Quote"</b> button to send.
			<br>Sent offers can be displayed under <b>"Tenders"</b> tab on left navigation menu</p>	
		</div>
